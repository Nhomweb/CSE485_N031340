...
class pagination
{
    ...
    private $_nPageShow;  //số lượng link page hiển thi
    private $_totalPage;  //tổng số page
    private $_currentPage;  //page hiển thị


    public function __construct($totalItem,$currentPage=1,$nItemOnPage=12,$nPageShow=12){
        ...
        if ($this->_nPageShow < $this->_totalPage) {
          ...
          for ($i == $startPage; $i <= $endPage; $i++) {
              if ($i == $this->_currentPage) {
                ...
                $listPages .="<li><a href='$actual_link&page=".$i."'>".$i.'</a></li>';
              }
          }
