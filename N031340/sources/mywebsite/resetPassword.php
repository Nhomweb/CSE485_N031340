	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
	    	...
	    	<?php if(isset($stop)){
				...
				<form role="form" method="post" action="" autocomplete="off" id="login-register-form">
					...
					<div class="row-submit">
						<div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Reset Password" class="btn btn-primary btn-block btn-lg" tabindex="3"></div>
					</div>
				</form>
